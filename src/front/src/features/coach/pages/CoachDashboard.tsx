...
import { routineService, type Routine } from "@/features/routines/services/routineService";
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          ...
          <button
            ...
            } text-white px-5 py-2.5 rounded-lg flex items-center justify-center gap-2 font-medium transition-colors`}
          >
