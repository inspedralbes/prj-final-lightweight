...
import ActiveSession from "../components/VirtualRoom/ActiveSession";
import SessionSummary from "../components/VirtualRoom/SessionSummary";
...
const SoloGymSession: FC = () => {
    ...
    const [finalStats, setFinalStats] = useState<{ time: number; volume: number; exercises: number } | null>(null);
