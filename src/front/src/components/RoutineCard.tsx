    ...
    <div className="bg-[#1a1a1a] rounded-xl p-5 border border-transparent hover:border-orange-500/20 transition-all duration-300 group shadow-lg hover:shadow-orange-500/5">
      ...
      <div className="flex items-center gap-4 text-sm text-gray-500 mt-4">
        <button
          ...
          className="flex items-center gap-1.5 bg-[#0a0a0a] px-2 py-1 rounded text-xs border border-[#2a2a2a] hover:border-orange-500/40 hover:text-orange-400 transition-colors cursor-pointer"
