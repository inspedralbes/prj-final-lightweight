...
This capability covers the global exercise catalog imported from the GitHub wrkout/exercises.json repository. It defines how exercises are stored, searched, and displayed — including exercise images sourced from the same repository.
...
- **THEN** the system SHALL NOT render any image element or placeholder
...
- **THEN** the failed image SHALL be hidden and remaining images SHALL still render
