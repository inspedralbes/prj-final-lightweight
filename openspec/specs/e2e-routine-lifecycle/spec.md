# Spec: e2e-routine-lifecycle

## Purpose

Tests E2E del cicle de vida complet de les rutines al dashboard del coach: creació, edició, eliminació i validació del formulari. Cobreix la interacció via la UI (Playwright) i la verificació de les crides a l'API corresponents.
